...
<head>
    ...
    <title> SUNNYTECH--欢迎使用自动化管理系统 </title>
    <jsp:include page="backend_common_work.jsp"/>
    ...
    <header class="navbar navbar-fixed-top navbar-shadow">
        <div class="navbar-branding">
            <a class="navbar-brand" href="#">
                <b style="color: red">SUNNYTECH</b>浙大旭日
            </a>
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-author">${sessionScope.employee.name},您好!</div>
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    <a href="">
                        ...
                        <span class="sidebar-title">项目总览</span>
                ...
                <li class="active">
                    <a href="">
                        ...
                        <span class="sidebar-title">分配项目</span>
                    </a>
                </li>
                <li>
                    <a href="">
                        <span class="fa fa-calendar"></span>
                        <span class="sidebar-title">查询项目</span>
                    </a>
                </li>
                <%--报销管理--%>
                <li class="sidebar-label pt20">报销管理</li>
                <li>
